package com.heytap.push.demo.component;
...
import com.heytap.push.demo.component.activity.AboutActivity;
import com.heytap.push.demo.component.fragment.BaseFragment;
import com.heytap.push.demo.component.fragment.PushConfigFragment;
import com.heytap.push.demo.component.fragment.PushInfoFragment;
import com.heytap.push.demo.component.fragment.UserBandingFragment;
import com.heytap.push.demo.constants.AppParam;
...
import static com.heytap.push.demo.util.TestModeUtil.TYPE_LOG;
...
public class DemoActivity extends AppCompatActivity implements TestModeUtil.UpdateTestMode {
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btn_check_opush_support:
                    addLog("isSupportPush", "" + HeytapPushManager.isSupportPush());
                    break;
                ...
                case R.id.btn_get_version_info:
                    ...
                    sb.append(",SdkVer:").append(HeytapPushManager.getSDKVersion());
    ...
    public void onPushTimeConfigChange(@Nullable View view) {
        ...
        try {
            HeytapPushManager.setPushTime(days, times.get(0), times.get(1), times.get(2), times.get(3));
